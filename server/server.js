...
// 임시: 띄어쓰기 제거 시 중복 메뉴 추출 (사용 후 제거)
app.get('/api/admin/dup-space-menus', async (req, res) => {
  try {
    const [rows] = await pool.execute('SELECT id, name, cat, count FROM menus ORDER BY name');
